...
#                   /products/sort-by-category  /products/browse
...
def sort_by_category():
    # key returns a tuple — Python sorts by category first (A→Z),
    # then by price within each category (cheapest first)
...
# ── Day 6 — Q4: Search orders by customer name ────────────────────
